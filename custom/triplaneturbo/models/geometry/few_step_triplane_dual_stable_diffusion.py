...
@threestudio.register("few-step-triplane-dual-stable-diffusion")
class StableDiffusionTriplaneDualAttention(BaseImplicitGeometry):
    ...
    class Config(BaseImplicitGeometry.Config):
        ...
        backbone: str = "few_step_triplane_dual_stable_diffusion"
    ...
    def configure(self) -> None:
        ...
        if self.cfg.backbone == "few_step_triplane_dual_stable_diffusion":
            from ...extern.few_step_triplane_dual_sd_modules import FewStepTriplaneDualStableDiffusion as Generator
