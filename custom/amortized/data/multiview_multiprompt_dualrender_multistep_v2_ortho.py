...
@register("multiview-multiprompt-dualrenderer-multistep-datamodule-v2-ortho")
class MultiviewMultipromptDualRendererMultiStepDataModule(pl.LightningDataModule):
    ...
    def __init__(self, cfg: Optional[Union[dict, DictConfig]] = None) -> None:
        ...
        negative_prompt_2nd = (
            self.cfg.guidance_processor.negative_prompt_2nd
            if hasattr(self.cfg.guidance_processor, "negative_prompt_2nd")
            else None
        )
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if stage in (None, "fit"):
            ...
            self.condition_processor.prepare_text_embeddings(prompt_lists)
            self.guidance_processor.prepare_text_embeddings(prompt_lists)
