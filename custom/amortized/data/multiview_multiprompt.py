...
class MultiviewMultipromptRandomCameraIterableDataset(
...
class MultiviewRandomCameraDataModule(pl.LightningDataModule):
    ...
    def __init__(self, cfg: Optional[Union[dict, DictConfig]] = None) -> None:
        ...
        self.cfg = parse_structured(
            MultiviewMultipromptRandomCameraDataModuleConfig, cfg
        )
        path = (
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        if stage in (None, "fit"):
            self.train_dataset = MultiviewMultipromptRandomCameraIterableDataset(
