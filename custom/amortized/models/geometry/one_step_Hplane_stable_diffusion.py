...
from ..geometry.utils import sample_from_Hplanes as sample_from_planes
...
class StableDiffusionHplaneAttention(BaseImplicitGeometry):
    ...
    def configure(self) -> None:
        ...
        if self.cfg.backbone == "one_step_Hplane_stable_diffusion":
            from ...extern.one_step_Hplane_sd_modules import (
                OneStepHplaneStableDiffusion as Generator,
            )
        ...
        elif self.cfg.interpolate_feat in ["v6", "v7"]:
