...
from ..geometry.utils import contract_to_unisphere_custom
from ..geometry.utils import sample_from_quaplanes as sample_from_planes
...
class StableDiffusionQuaplaneAttention(BaseImplicitGeometry):
    ...
    def configure(self) -> None:
        ...
        if self.cfg.backbone == "one_step_quaplane_stable_diffusion":
            from ...extern.one_step_quaplane_sd_modules import (
                OneStepQuaplaneStableDiffusion as Generator,
            )
    ...
    def interpolate_encodings(
        ...
        if self.cfg.rotate_planes == "v1":
            ...
            space_cache_rotated[:, 0::4] = torch.transpose(space_cache[:, 0::4], 3, 4)
            ...
            space_cache_rotated[:, 3::4] = torch.rot90(
                torch.flip(space_cache[:, 3::4], dims=(4,)), k=-1, dims=(3, 4)
            )
