...
from extern.nd_sd.ldm.modules.diffusionmodules.model import Decoder, Encoder
from extern.nd_sd.ldm.modules.distributions.distributions import (
    DiagonalGaussianDistribution,
)
from extern.nd_sd.ldm.util import filter_nan_loss, instantiate_from_config
...
class AutoencoderKL(pl.LightningModule):
    ...
    def prior_inference(self, inputs, prior_inputs):
        ...
        if self.using_rgb:
            ...
            return torch.cat(
                [resize_prior_results["normal"], resize_prior_results["depth"]], dim=1
            )
