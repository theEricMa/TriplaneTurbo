...
from extern.nd_sd.ldm.util import instantiate_from_config

PRETRAINED_MODELS = {
    "nd-mv": {
        "config": "configs/inference/nd/txtcond_mvsd-4-objaverse_finetune_wovae.yaml",
    },
}
...
def build_model(
    model_name, ckpt_path=None, cache_dir=None, return_cfg=False, strict=True
):
